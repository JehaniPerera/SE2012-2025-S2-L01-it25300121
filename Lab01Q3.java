...
System.out.println("\n--------------------------------------------------------------");
System.out.printf("%-12s | %-18s | %-18s | %-18s%n", "Student ID", "Mathematics", "Chemistry", "Physics");
System.out.println("--------------------------------------------------------------");

for (int i = 1; i <= n; i++) {
String mathGrade = hasMarks[i][1] ? calculateGrade(marks[i][1]) : "N/A";
String chemGrade = hasMarks[i][2] ? calculateGrade(marks[i][2]) : "N/A";
String phyGrade = hasMarks[i][3] ? calculateGrade(marks[i][3]) : "N/A";

System.out.printf("%-12d | %-18s | %-18s | %-18s%n", i, mathGrade, chemGrade, phyGrade);
}
System.out.println("--------------------------------------------------------------\n");
